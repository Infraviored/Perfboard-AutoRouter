# AutoRouter Mathematical & Algorithmic Architecture

This document serves as a technical deep-dive into the engine and mathematics powering the Perfboard AutoRouter. The core of this project is an advanced, heuristic-driven constraint solver and placement engine that simultaneously handles 2D bin packing, pathfinding, and graph optimization algorithms to lay out components and route wired connections on a discrete perfboard grid.
...
The perfboard is represented as a discrete 2D coordinate system. 
